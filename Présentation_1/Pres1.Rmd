...
\begin{exampleblock}{Transformation possible}
\begin{equation} 
...
- Désavantages : 
    ...
    - Les données sont souvent asymétriques $\rightarrow$ problèmes pour les tests d'hypothèses et les intervalles de confiance.
